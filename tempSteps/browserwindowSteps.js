...
When('I go to on the page {string}', function (string) {
    // Write code here that turns the phrase above into concrete actions
    return null;
});
...
When('I go to on the title {string}', function (string) {
    // Write code here that turns the phrase above into concrete actions
    return null;
});

//
//When I do not go to string
//

When('I do not go to {string}', function (string) {
    // Write code here that turns the phrase above into concrete actions
    return null;
});
...
When('I do not go to the page {string}', function (string) {
    // Write code here that turns the phrase above into concrete actions
    return null;
});

When('I do not go to the title {string}', function (string) {
    // Write code here that turns the phrase above into concrete actions
    return null;
});
